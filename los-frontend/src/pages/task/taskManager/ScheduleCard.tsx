...
const ScheduleCard = ({
  ...
  onEditTaskHandler?: (item: any) => void;
}) => {
  ...
  const canEdit = isCreatedUser && hasPermission(PERMISSIONS.TASK_UPDATE);
            ...
            <div className="flex flex-col gap-1.5 flex-shrink-0">
              ...
              {canEdit && (
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-8 w-8 p-0 hover:bg-color-primary/10 hover:text-color-primary"
                  onClick={() => onEditTaskHandler?.(item)}
                >
          ...
          <div className="flex items-center gap-2 ml-4 flex-wrap">
            ...
            {canEdit && (
              <Button
                variant="ghost"
                size="sm"
                className="hover:bg-color-primary/10 hover:text-color-primary"
                onClick={() => onEditTaskHandler?.(item)}
              >
