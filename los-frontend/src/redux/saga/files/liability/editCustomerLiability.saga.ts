...
import { EDIT_CUSTOMER_LIABILITY_DATA } from '@/redux/actions/types';
import { setActiveStep } from '@/redux/slices/files';
import { setError } from '@/redux/slices/files/liability';
import { setLoading } from '@/redux/slices/publicSlice';
import { call, put, takeEvery } from 'redux-saga/effects';

function* editCustomerLiabilitySaga(action: ISagaProps) {
...
export default function* editCustomerLiability() {
  yield takeEvery(EDIT_CUSTOMER_LIABILITY_DATA, editCustomerLiabilitySaga);
}
