...
import { setData, setError } from '@/redux/slices/files/associates';
import { setLoading } from '@/redux/slices/publicSlice';
import { call, put, takeEvery } from 'redux-saga/effects';

function* fetchCustomerAssociatesSaga() {
...
export default function* fetchCustomerAssociates() {
  yield takeEvery(GET_CUSTOMER_ASSOCIATES_DATA, fetchCustomerAssociatesSaga);
}
