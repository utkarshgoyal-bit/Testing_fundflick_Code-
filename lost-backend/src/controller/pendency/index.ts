...
class PendencyController {
    async getPendency(req: Request, res: Response): Promise<void> {
        try {
            ...
            const pendencyData = await PendencyServices.getPendency({ loginUser, active: active === 'true' ? true : false, fileId: fileId as string });
            ApiResponseHandler.sendResponse(res, StatusCodes.OK, pendencyData, 'Pendency ' + SUCCESS.FETCHED);
        } catch (error) {
    ...
    async createPendency(req: Request, res: Response): Promise<void> {
        try {
            ...
            ApiResponseHandler.sendResponse(res, StatusCodes.OK, pendencyData, 'Pendency ' + SUCCESS.CREATED);
        } catch (error) {
            ApiResponseHandler.sendErrorResponse(res, error, ERROR.BAD_REQUEST);
        }
    }
    async updatePendency(req: Request, res: Response): Promise<void> {
        try {
            ...
            ApiResponseHandler.sendResponse(res, StatusCodes.OK, pendencyData, 'Pendency ' + SUCCESS.UPDATED);
        } catch (error) {
            ApiResponseHandler.sendErrorResponse(res, error, ERROR.BAD_REQUEST);
        }
    }
    async deletePendency(req: Request, res: Response): Promise<void> {
        try {
            ...
            ApiResponseHandler.sendResponse(res, StatusCodes.OK, pendencyData, 'Pendency ' + SUCCESS.DELETED);
        } catch (error) {
            ApiResponseHandler.sendErrorResponse(res, error, ERROR.BAD_REQUEST);
        }
    }
