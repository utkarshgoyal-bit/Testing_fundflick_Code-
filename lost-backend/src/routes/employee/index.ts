...
router.delete("/block", hasPermission(PERMISSIONS.EMPLOYEE_BLOCK), EmployeesControllers.blockEmployee);
router.patch("/unblock", hasPermission(PERMISSIONS.EMPLOYEE_UNBLOCK), EmployeesControllers.unblockEmployee);
