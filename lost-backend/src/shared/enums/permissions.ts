export enum PERMISSIONS {
  ...
  COLLECTION_VIEW_DAILY_PAYMENTS_BRANCH_WISE = "collection_view_daily_payments_branch_wise",
  ...
  COLLECTION_VIEW_DAILY_FOLLOWUPS_BRANCH_WISE = "collection_view_daily_followups_branch_wise",
